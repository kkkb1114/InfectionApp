package kkkb1114.sampleproject.infectionapp.thermometer;
...
public class ThermometerView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        scaleTextColor = typedArray.getColor(R.styleable.Thermometer_scaleTextColor, Color.parseColor("#464646"));
        maxScaleLineColor = typedArray.getColor(R.styleable.Thermometer_maxScaleLineColor, Color.parseColor("#787878"));
        midScaleLineColor = typedArray.getColor(R.styleable.Thermometer_midScaleLineColor, Color.parseColor("#A9A9A9"));
        minScaleLineColor = typedArray.getColor(R.styleable.Thermometer_minScaleLineColor, Color.parseColor("#A9A9A9"));
        scaleLineWidth = typedArray.getFloat(R.styleable.Thermometer_scaleLineWidth, 1.5f);
        maxLineWidth = typedArray.getFloat(R.styleable.Thermometer_maxLineWidth, 70f);
        midLineWidth = typedArray.getFloat(R.styleable.Thermometer_midLineWidth, 50f);
        minLineWidth = typedArray.getFloat(R.styleable.Thermometer_minLineWidth, 40f);
        spaceScaleWidth = typedArray.getFloat(R.styleable.Thermometer_spaceScaleWidth, 30f);
        thermometerBg = typedArray.getColor(R.styleable.Thermometer_thermometerBg, Color.WHITE);
        thermometerShadowBg = typedArray.getColor(R.styleable.Thermometer_thermometerShadowBg, Color.parseColor("#F0F0F0"));
        maxThermometerRadius = typedArray.getFloat(R.styleable.Thermometer_maxThermometerRadius, 80f);
        minThermometerRadius = typedArray.getFloat(R.styleable.Thermometer_minThermometerRadius, 40f);
        maxMercuryRadius = typedArray.getFloat(R.styleable.Thermometer_maxMercuryRadius, 60f);
        minMercuryRadius = typedArray.getFloat(R.styleable.Thermometer_minMercuryRadius, 20f);
        leftMercuryBg = typedArray.getColor(R.styleable.Thermometer_leftMercuryBg, Color.parseColor("#FFE6E0"));
        rightMercuryBg = typedArray.getColor(R.styleable.Thermometer_rightMercuryBg, Color.parseColor("#FDE1DE"));
        leftMercuryColor = typedArray.getColor(R.styleable.Thermometer_leftMercuryColor, Color.parseColor("#FF8063"));
        rightMercuryColor = typedArray.getColor(R.styleable.Thermometer_rightMercuryColor, Color.parseColor("#F66A5C"));
        maxScaleValue = typedArray.getFloat(R.styleable.Thermometer_maxScaleValue, 42f);
        minScaleValue = typedArray.getFloat(R.styleable.Thermometer_minScaleValue, 35f);
        curScaleValue = typedArray.getFloat(R.styleable.Thermometer_curScaleValue, 35f);
        typedArray.recycle();
